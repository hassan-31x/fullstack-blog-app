...
const Login = () => {
  const [inputs, setInputs] = useState({ username: "test", password: "test" });
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-lightOrange flex-col">
      ...
      <form className="flex flex-col p-12 bg-white gap-5 w-96">
        ...
        />
        <button
          className="p-3 bg-secondaryColor hover:text-white hover:bg-darkSecondary border border-black text-black cursor-pointer drop-shadow-[3px_4px_0px_rgba(0,0,0,1)] rounded-md relative hover:bottom-1"
        ...
        <span className="text-md text-center text-secondaryBlack">
          ...
          <Link to="/register" className="text-darkSecondary underline">
            Register
          </Link>
        </span>
      </form>
